...
2. 카테고리별 가중치
   ...
   ③ 공급망/원자재(supply_chain): 반도체, 에너지, 핵심 원자재 공급 차질·가격 급등락
   ④ 기업 펀더멘탈(fundamental): 미국 시총 상위 기업·주요 섹터에 직접 영향

3. 자산 전이도: S&P 500, Nasdaq, 미국 국채 금리, 달러 인덱스에 직접 변동성 유발 가능성

4. 스코어링
   - 시장 긴급성(urgencyScore): 1~5점
   - 미국 증시 연관도(marketScore): 1~5점
